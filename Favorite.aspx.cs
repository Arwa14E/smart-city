...
public partial class Favorite : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string a = Request.Cookies["uid"].Value.ToString();
    ...
    protected void DataList1_ItemCommand(object source, DataListCommandEventArgs e)
    {
        if (e.CommandName == "Like")
        {
            ...
            if (like_bt.ForeColor == Color.Black)
            {
                ...
                C.con.Open();
                {
                    SqlCommand cmd = new SqlCommand("UPDATE Items SET likes = likes + 1 WHERE  (Tybe = 1) and id = '" + tl.Text + "'", C.con);
                    cmd.ExecuteNonQuery();
                }
                {
        ...
        if (e.CommandName == "CH")
        {
            ...
            //Label tl = (Label)DataList1.Items[e.Item.ItemIndex].FindControl("Label19");
            //HtmlGenericControl ved = (HtmlGenericControl)DataList1.Items[e.Item.ItemIndex].FindControl("Ed_Vedio");
            //ved.Attributes["src"] = tl.Text;
            //DataList1.EditItemIndex = e.Item.ItemIndex;
            //DataList1.DataBind();
