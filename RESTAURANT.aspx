<%@ Page Title="" Language="C#" MasterPageFile="~/Items_Master.master" AutoEventWireup="true" CodeFile="RESTAURANT.aspx.cs" Inherits="RESTAURANT" %>
    ...
    <table style="width: 100%">
        <tr>
            ...
            <td style="text-align: center; font-size: xx-large; color: #E4E4E4">
                <h1> RESTAURANT </span></h1>
                <asp:Button ID="Button7" runat="server" BackColor="#3E342B" BorderColor="White" 
                    Font-Bold="True" ForeColor="White" Height="39px" onclick="Button7_Click" 
                    Text="Add New" Width="103px" />
                &nbsp;</td>
            <td>
                &nbsp;</td>
        </tr>
            ...
            <td style="text-align: center; font-size: xx-large; color: #E4E4E4">
                ...
                style="color: #FFFFFF">Name</span><asp:Label ID="Label20" runat="server" Text='<%# Eval("ID") %>' 
                                    ...
                                    <tr>
                                        ...
                                        Text='<%# Eval("source") %>' Visible="false"></asp:Label>
                            ...
                            <tr>
                                <td style="text-align: center; width: 450px;">
                                    <asp:ImageButton ID="ImageButton2" runat="server" CommandName="Edit" 
                                        Height="40px" ImageUrl="~/img/edit111.png" Width="40px" />
                                    <asp:ImageButton ID="ImageButton1" runat="server" CommandName="Del" 
                                        CssClass="bt111" Height="40px" ImageUrl="~/img/CANCEL.png" 
...
<br />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [Items] WHERE [Id] = @original_Id" 
                    OldValuesParameterFormatString="original_{0}" 
                    SelectCommand="SELECT * FROM [Items] WHERE ([Tybe] = @Tybe) ORDER BY [likes] DESC" 
                    UpdateCommand="UPDATE [Items] SET [name] = @name, [Tybe] = @Tybe, [source] = @source, [Note] = @Note, [link] = @link, [likes] = @likes WHERE [Id] = @original_Id">
                    <DeleteParameters>
                        <asp:Parameter Name="original_Id" Type="Int32" />
                    </DeleteParameters>
                    <SelectParameters>
                        <asp:Parameter DefaultValue="5" Name="Tybe" Type="Int32" />
                    </SelectParameters>
                    <UpdateParameters>
